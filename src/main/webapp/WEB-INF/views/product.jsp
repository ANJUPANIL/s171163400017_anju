...
/*
function onchangecontroller($scope, $http) {
		var bid = $("#brand").val();
		alert("onchange" + bid);
	...
	<div class="container">
		...
		<div class="pull-right nav hidden-xs">
			<i class="fa fa-angle-left" style="color: #0000CD"> <span
				class="glyphicon glyphicon-user"></span>Welcome Admin
			</i>&nbsp; &nbsp; <a href="logout"><i class="fa fa-angle-left"><span
...
<!-- 
				<tr class="form-group">
					...
					<td><form:input path="id" size="40" class="form-control"
							required="true" autofocus="true" /><br /> <form:errors path="id"
							cssClass="error" /></td>
 ...
 -->
				...
				<tr class="form-group">
					...
					<td><form:select path="brands.brand_id" id="brand"
							class="form-control">
  							 <form:option value="NONE" label="--- Select Brand---"/>
   							<form:options items="${brand}" itemValue="brand_id"
							itemLabel="brand_name" /></form:select><br /> 
				...
				<tr class="form-group">
					...
					<td><form:select path="categoryobj.id" class="form-control" id="category">
					<form:option value="NONE" label="--- Select Category---"/></form:select> <br /> 
				...
				<tr class="form-group">
					...
					</select><br /> <form:errors path="product_type" cssClass="error" /></td>
				</tr>

				<tr class="form-group">
					<td><form:label path="sup.id">Supplier</form:label></td>
					<td><form:select path="sup.id" class="form-control">
					<form:option value="NONE" label="--- Select Supplier---"/>
   							<form:options items="${supplier}" itemValue="id" itemLabel="name" /></form:select>
							 <br /> <form:errors
							path="sup.id" cssClass="error" /></td>
				</tr>
				...
				<tr class="form-group">
					...
					<td><form:input path="discount" class="form-control"
							required="true" /><br /> <form:errors path="discount"
							cssClass="error" /></td>
				</tr>
	...
	<div class="row" data-ng-app="app"
		data-ng-controller="product_controller" align="center">
			...
			<div class="panel-heading" align="left">
				...
				<div class="pull-right">
					<input type="text" class="form-control" size="40"
						ng-model="searchTerm" placeholder="Search Product" />
				</div>
			</div>
			<div align="center" class="table-responsive">
						...
						<td>
							<table class="table">
								...
								<tr data-ng-repeat="p in products | filter:searchTerm">
									...
									<td>{{p.price}}</td>
									<td>{{p.discount}}</td>
									<td><img src="<c:out value='{{p.product_image}}' />"
										width="150px" height="150px"></td>
									</td>

									<td><a href="editproduct?id={{p.id}}"
										class="btn btn-primary" role="button" style="width: 92px">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a href="delproduct?id={{p.id}}" class="btn btn-warning"
										role="button" style="width: 92px"
