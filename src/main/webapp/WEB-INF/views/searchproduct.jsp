				...
				<c:when test="${empty emptymsg==true}">
					<div class="col-md-4">
						<div class="mag">
							...
							<img data-toggle="magnify" src="${product[0].product_image}"
								alt="">
						</div>
					</div>
					<!--/span-->
					...
					<div class="col-md-4">
						...
						<p style="color: #7f8496;">
							<b>Category : </b>${product[0].categoryobj.name}&nbsp;&nbsp; <i
								style="color: red">${product[0].product_type} </i>
						</p>
						<br>
					...
					<div class="col-xs-12 col-md-8" align="right">
						<a class="btn btn-primary" href="addcart?id=${product[0].id}"><span
							class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<c:choose>
							<c:when test="${empty userid or loggedout ==true}">
								<a href="productgallery?name=${product[0].categoryobj.name}"
									class="btn btn-warning" role="button"><span
									class="glyphicon glyphicon-shopping-cart"></span>Continue
									Shopping</a>
							</c:when>
							<c:when test="${not empty userid }">
								<a href="shopproduct?name=${product[0].categoryobj.name}"
									class="btn btn-warning" role="button"><span
									class="glyphicon glyphicon-shopping-cart"></span>Continue
									Shopping</a>
							</c:when>
